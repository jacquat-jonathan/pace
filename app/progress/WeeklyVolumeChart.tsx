  ...
  return (
    <ResponsiveContainer width="100%" height={380}>
      <ComposedChart data={data}>
        ...
        <Tooltip contentStyle={{ border: '1px solid #dddcd5', borderRadius: 12, boxShadow: '0 12px 30px rgb(23 33 38 / 10%)' }} labelFormatter={(value) => `Week of ${format(new Date(value), 'MMM d, yyyy')}`} />
