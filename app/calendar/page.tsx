...
export default async function CalendarPage() {
  ...
  const [sessions, customActivityTypes, activityTypeIcons] = await Promise.all([
  ...
  return (
    <div className="page">
      ...
      <CalendarClient initialSessions={sessions} activityTypes={toActivityTypeOptions(customActivityTypes, activityTypeIcons)} />
    </div>
  )
}
